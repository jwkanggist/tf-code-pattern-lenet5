Readme for  TF Code Pattern Design with Lenet5-Mnist
==================================
...
![alt text](https://github.com/jwkanggist/tf-code-pattern-lenet5/blob/develop/images/tf_pattern_uml2.jpg)
